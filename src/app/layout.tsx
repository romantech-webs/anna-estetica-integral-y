  ...
  return (
    <html lang="es">
      <head>
        ...
        <script dangerouslySetInnerHTML={{ __html: `window.__WIDGET_API_URL="https://automatizacion-webs.vercel.app";window.__PROJECT_ID="anna-estetica-integral-y";` }} />

        <script
          src="https://automatizacion-webs.vercel.app/widget.js"
          data-project-name="Anna estética integral y bienestar"
          data-api-url="https://automatizacion-webs.vercel.app"
          data-project-id="anna-estetica-integral-y"
      ...
      <body className="font-sans">
        ...
        <script dangerouslySetInnerHTML={{ __html: `
          (function(){
            ...
            var pid="anna-estetica-integral-y";
